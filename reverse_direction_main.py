            ...
            if is_slide_show_running():  # Check if slide show is running
                if is_hand_vertical:
                    if fingertips_to_left:
                        print("Next Slide")  # Reversed behavior: left gesture goes to the next slide
                        Presentation.SlideShowWindow.View.Next()
                        lastGestureTime = time.time()
                    elif fingertips_to_right:
                        print("Previous Slide")  # Reversed behavior: right gesture goes to the previous slide
                        Presentation.SlideShowWindow.View.Previous()
                        lastGestureTime = time.time()
                else:
                    print("Horizontal Hand Gesture Detected")
